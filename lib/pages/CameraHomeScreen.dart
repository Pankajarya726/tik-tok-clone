                    ...
                    Align(
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            !_startRecording ? onVideoRecordButtonPressed() : onStopButtonPressed();
                            setState(() {
                          ...
                          child: Container(
                            ...
                            child: Image.asset(
                              !_startRecording ? _assetVideoRecorder : _assetStopVideoRecorder,
                              width: 72.0,
                              height: 72.0,
                            ),
                          ),
    ...
    return Align(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.all(Radius.circular(50.0)),
          onTap: () {
            !_toggleCamera ? onCameraSelected(widget.cameras[1]) : onCameraSelected(widget.cameras[0]);
            setState(() {
